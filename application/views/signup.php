...
<html lang="en">
 ...
 <head>
    <meta charset="utf-8">
    <title>Signup - Mangala Studio</title>
...
<div class="account-container register">
	...
	<div class="content clearfix">
		...
		<form id="form_signup" method="post" action="<?=base_url()?>/index.php/main/save/signup">
			...
			<div class="login-actions">
				...
				<button class="button btn btn-primary btn-large" id="btnSignup">Sign Up</button>
...
<div class="login-extra">
	Already have an account? <a href="?action=login">Login to your account</a>
</div> <!-- /login-extra -->
